...
#SBATCH --job-name=test_loc_updated
...
# run the script
python -m scripts.train_selection_heads --model="google/gemma-2-27b-it" --train_limit=512 --validation_limit=256 --n_epochs=10 --category="objects" --option_config="distinct" --opt_interface="updated" -v |& tee gemma_27b_it_updated.log