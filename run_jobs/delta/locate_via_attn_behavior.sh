...
#SBATCH --job-name=locate_attn_behavior
...
# run the script
python -m scripts.locate_via_attention_behavior --model="meta-llama/Llama-3.3-70B-Instruct" --limit=2048 --task="select_one" --category_type="objects" -v